...
export async function summarizeHistoricalEstimates(
  ...
  try {
    ...
    console.error('Errore durante la generazione del riassunto di una stima storica:', error);
...
export async function generateEstimate(
  ...
  const prompt = createPrompt(techStack, scope, requirements, notes, historicalContext);
